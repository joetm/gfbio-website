...
<div class="row center-align">
  ...
  <h1 class="flow-text">DEVELOPER</h1>
  <p class="flow-text">
	<?php
...
<div class="row">
      ...
      <div class="col s12 m6 center-align">
          <h2 class="flow-text"><a href="/api/">API</a></h2>
            <p>
            ...
            <p>
                <a href="/api/">&#8594; How to use the API</a>
            </p>
      </div>
      <div class="col s12 m6 center-align">
          <h2 class="flow-text"><a href="/widgets/">Widgets</a></h2>
            <p>
            ...
            <p>
                <a href="/widgets/">&#8594; How to use the widgets</a>
            </p>
      </div>
...
<div class="container">
    <div class="row">
        <div class="col s12 m6">
          <div class="card hoverable white darken-1 z-depth-4">
            <div class="card-content black-text">
              <span class="card-title flow-text">API</span>
                <p>
                Access to the GFBio TS is provided via a RESTful web
                service. All terms and terminologies can be accessed via
                a common interface, regardless of whether they are hosted
        ...
        <div class="col s12 m6">
          <div class="card hoverable white darken-1 z-depth-4">
            <div class="card-content black-text">
              <span class="card-title flow-text">Widgets</span>
                <p>
                Widgets are ready web applications based on the TS API to be used on your website with just little configuration and programming skills needed. Widgets deliver restricted functionality for one purpose.
                </p>
            </div>
...
<div class="container">
<div class="row">
      <h2 class="center-align flow-text" id="technology">Technology Behind</h2>
      <p>
