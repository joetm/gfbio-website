...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"app","1":"home"}[chunkId]||chunkId) + ".js";
	...
	!function (e, n, s) {
	  function o(e, n) {
	    ...
	    var n = r.className,
	      ...
	      Modernizr = function Modernizr() {};Modernizr.prototype = f, Modernizr = new Modernizr();var r = n.documentElement,
	      c = "svg" === r.nodeName.toLowerCase();Modernizr.addTest("svg", !!n.createElementNS && !!n.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), a(), t(i), delete f.addTest, delete f.addAsyncTest;for (var u = 0; u < Modernizr._q.length; u++) {
	    Modernizr._q[u]();
...
/***/ }
/******/ ]);
//# sourceMappingURL=libs.js-2.map